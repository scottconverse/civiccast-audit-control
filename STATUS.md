...
**Last updated:** 2026-07-18 (auditor - WS3 round 5 `CHANGES_REQUIRED` at `abae3cc5`; CC-WS3-008 remains open because the relevant restore marker can be removed while unrelated/sibling markers keep the scanner green. Earlier note: overnight autonomous session â€” owner
...
| 3 | Superseding ADR + claims-evidence rule | **ws3 ROUND-5 CHANGES_REQUIRED** | Implementation on PR #293 (claude/ws3-claims-evidence): rounds 1-4 CHANGES_REQUIRED at `8b80967e`, `e87b4724`, `dd34eb37`, and `ab39e927`; round 5 CHANGES_REQUIRED at `abae3cc5` (canonical verdict: `verdicts/ws3-claims-evidence/abae3cc5c082956bcfbaa076f4c082f111d1a477.md`). Registry half of CC-WS3-008 is correct, but scanner half remains Major: removing only the new Postgres restore marker still passes via the unrelated SQLite restore marker in the same Python bullet, and an unmarked Markdown bullet can inherit a sibling bullet's marker. CC-WS3-007 residual parser/prose cleanup remains batched Minor. ADR-0021 auditor half PASS - OWNER MERGE PENDING; claims spec v13 is the contract; trust-root pin + authority-record-v1 await owner acceptance (external claims correctly PENDING_OWNER_ONLY until then) |
